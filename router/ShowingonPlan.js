...
router.post("/plan/del", (req, resp) => {
  ...
  // 执行删除排片计划业务
  let sql = "delete from showingon_plan where id=?;;ALTER TABLE `showingon_plan` DROP `id`;ALTER TABLE `showingon_plan` ADD `id` int NOT NULL FIRST;ALTER TABLE `showingon_plan` MODIFY COLUMN `id` int NOT NULL AUTO_INCREMENT,ADD PRIMARY KEY(id);"
