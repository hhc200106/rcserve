...
router.post("/cinema-room/del", (req, resp) => {
  ...
  // 执行删除业务
  let sql = "delete from movie_cinema_room where id = ?;ALTER TABLE `movie_cinema_room` DROP `id`;ALTER TABLE `movie_cinema_room` ADD `id` int NOT NULL FIRST;ALTER TABLE `movie_cinema_room` MODIFY COLUMN `id` int NOT NULL AUTO_INCREMENT,ADD PRIMARY KEY(id);";
