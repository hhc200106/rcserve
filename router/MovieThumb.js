 ...
 */
 router.post('/movie-thumb/del', (req, resp)=>{
    ...
    // 执行删除业务
    let sql = "delete from movie_thumb where id = ?;ALTER TABLE `movie_thumb` DROP `id`;ALTER TABLE `movie_thumb` ADD `id` int NOT NULL FIRST;ALTER TABLE `movie_thumb` MODIFY COLUMN `id` int NOT NULL AUTO_INCREMENT,ADD PRIMARY KEY(id);"
