 ...
 */
 router.post("/cinema/del", (req, resp) => {
  ...
  // 执行删除业务
  let sql = "delete from movie_cinema where id = ?;ALTER TABLE `movie_actor` DROP `id`;ALTER TABLE `movie_cinema` ADD `id` int NOT NULL FIRST;ALTER TABLE `movie_cinema` MODIFY COLUMN `id` int NOT NULL AUTO_INCREMENT,ADD PRIMARY KEY(id);";
