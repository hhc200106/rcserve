...
router.post("/movie-info/del", (req, resp) => {
  ...
  // 执行删除业务
  let sql = "delete from movie_info where id = ?;ALTER TABLE `movie_info` DROP `id`;ALTER TABLE `movie_info` ADD `id` int NOT NULL FIRST;ALTER TABLE `movie_info` MODIFY COLUMN `id` int NOT NULL AUTO_INCREMENT,ADD PRIMARY KEY(id);";
